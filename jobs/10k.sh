...
CACHE_SUBDIR="${CACHE_SUBDIR:-10k}"
GEN_MAX_TRAIN="${GEN_MAX_TRAIN:-10000}"
GEN_MAX_VAL="${GEN_MAX_VAL:-10000}"
GEN_MAX_TEST="${GEN_MAX_TEST:-10000}"
GEN_MAX_OOD_VAL="${GEN_MAX_OOD_VAL:-10000}"
GEN_MAX_OOD_TEST="${GEN_MAX_OOD_TEST:-10000}"
...
PIPELINE_LOG_BASENAME="${PIPELINE_LOG_BASENAME:-Llama-10k.log}"
